...
export default async function PedidosListaPage() {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-2xl font-semibold">Pedidos — lista completa</h1>
          <p className="text-sm text-neutral-600">
            Inclui pedidos cancelados (que não aparecem no dashboard).
          </p>
        </div>
        <Link
          href="/pedidos/novo"
